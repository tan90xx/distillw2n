...
--config configs/distillw2n_16khz.json \
--input_wavs_dir /data1/tizzytan/bsrnn_data/LibriTTS \
--input_training_file filelists/LibriTTS/train-clean.txt \
--input_validation_file filelists/LibriTTS/val-full.txt \
--list_input_unseen_wavs_dir /data1/tizzytan/bsrnn_data/LibriTTS /data1/tizzytan/bsrnn_data/LibriTTS \
--list_input_unseen_validation_file filelists/LibriTTS/dev-clean.txt filelists/LibriTTS/dev-other.txt \
--checkpoint_path /data1/tizzytan/bsrnn_data/exp/distillw2n_16khz_80band
