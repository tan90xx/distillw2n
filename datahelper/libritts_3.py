...
def load_libritts_item(
    ...
    fileid_audio = Path(str(file_audio).replace('LibriTTS', "LibriTTS-{}".format("vad-ppw")))
    waveform_ppw, sample_rate = torchaudio.load(fileid_audio)
    fileid_audio = Path(str(file_audio).replace('LibriTTS', "LibriTTS-{}".format("vad")))
