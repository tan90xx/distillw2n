...
spk_model = nemo_asr.models.EncDecSpeakerLabelModel.restore_from("./models/speakerverification_en_titanet_large.nemo", map_location='cpu')
    ...
    def __getitem__(
        ...
        try:
            ...
            if not self.fine_tuning:
                ...
                mel_path = filename.replace("LibriTTS", "LibriTTS_mel").replace(".wav", ".npy")
                ...
                hubert_path = filename.replace("LibriTTS", "LibriTTS_hubert").replace(".wav", ".npy")
                ...
                f0_path = filename.replace("LibriTTS", "LibriTTS_f0").replace(".wav", ".npy")
                ...
                spk_path = filename.replace("LibriTTS", "LibriTTS_spk").replace(".wav", ".npy")
            ...
            return (mel.squeeze(), audio.squeeze(0), unit.squeeze(), f0.squeeze(), spk.squeeze(), mel_loss.squeeze())
...
def main():
    ...
    for i, batch in enumerate(dataloader):
        ...
        assert audio.shape[1] == mel.shape[2] * dataset.hop_size, \
